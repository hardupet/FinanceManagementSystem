...
{
    /// <inheritdoc />
    public partial class FinanceManagementSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalTransactionsAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsBalanceUpdate = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AlertID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LowBalanceAlertEnabled = table.Column<bool>(type: "bit", nullable: false),
                    LowBalanceThreshold = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    HighBalanceAlertEnabled = table.Column<bool>(type: "bit", nullable: false),
                    HighBalanceThreshold = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    OverspendingAlertEnabled = table.Column<bool>(type: "bit", nullable: false),
                    DueDateReminderAlertEnabled = table.Column<bool>(type: "bit", nullable: false),
                    IncomeDepositedAlertEnabled = table.Column<bool>(type: "bit", nullable: false),
                    TargetAmountReachedAlertEnabled = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
